...
#ifndef PROPERTYBASEDTABLEMODEL_POINT_H
#define PROPERTYBASEDTABLEMODEL_POINT_H
...
//! @ingroup oculars
class PropertyBasedTableModel_Point : public QAbstractTableModel
{
	Q_OBJECT
public:
    PropertyBasedTableModel_Point(QObject *parent = Q_NULLPTR);
    virtual ~PropertyBasedTableModel_Point();
