...
Sweep::Sweep(const QObject& other)
    : m_startRA(other.property("StartingRA").toString()),
      m_endRA(other.property("EndingRA").toString()),
      m_startDec(other.property("TopDec").toString()),
      m_endDec(other.property("BottomDec").toString()),
      m_date(other.property("DateOfObs").toString()),
      m_name(other.property("NameOfSweep").toString())
...
QMap<int, QString> Sweep::propertyMap(void)
{
	if(mapping.isEmpty()) {
        ...
        mapping[0] = "NameOfSweep";
        mapping[1] = "StartingRA";
        mapping[2] = "EndingRA";
        mapping[3] = "TopDec";
        mapping[4] = "BottomDec";
        mapping[5] = "DateOfObs";
