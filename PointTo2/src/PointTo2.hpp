/*
        the header file for the PointTo2 function, which will slew the telescope to the midpoint of a particular obsevation area on a date and time
*/

#ifndef _POINTTO2_HPP_
#define _POINTTO2_HPP_
...
#define MIN_POINTTO2_INI_VERSION 1.0
...
/*! @defgroup pointto2 PointTo2 Plug-in
@{
@}
*/

//! Main class of the PointTo2 plug-in.
//! @class PointTo2
//! @ingroup pointto2
class PointTo2 : public StelModule
{
    Q_OBJECT
...
class PointTo2StelPluginInterface : public QObject, public StelPluginInterface
{
    Q_OBJECT
