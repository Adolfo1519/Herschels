/*
 This is an attempt to create a .cpp file that will run the PointTo plugin dialog
*/
...
#endif
/* ********************************************************************* */
void PointToDialog::retranslate()
{
	if (dialog) {
...
#endif
/* ********************************************************************* */
void PointToDialog::closeWindow()
{
	setVisible(false);
...
void PointToDialog::deleteSelectedSweep()
{
...
//Insert a new sweep
void PointToDialog::insertNewSweep()
{
...
void PointToDialog::moveUpSelectedSweep()
{
...
void PointToDialog::moveDownSelectedSweep()
{
	int index = ui->sweepListView->currentIndex().row();
...
#endif
/* ********************************************************************* */
void PointToDialog::createDialogContent()
{
	ui->setupUi(dialog);
...
//**************************************************************
/*void PointToDialog::setLabelsDescriptionText(bool state)
{
	if (state)
	{
...
/*
void PointToDialog::initAboutText()
{
