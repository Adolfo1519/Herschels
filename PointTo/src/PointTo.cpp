/*
This is the PointTo plugin main class. It can just take in essentially the corners of a box in
...
void PointTo::point(StelCore* core)
{
...
void PointTo::displayPopupMenu()
{
    ...
    else
    {
        ...
        action->setCheckable(true);
        action->setChecked(pointtoDialog->visible());
...
void PointTo::initializeActivationActions()
{
    ...
    actionConfiguration  = addAction("actionOpen_PointTo_Configuration", sweepsGroup, N_("PointTo plugin configuration"), pointtoDialog, "visible");
